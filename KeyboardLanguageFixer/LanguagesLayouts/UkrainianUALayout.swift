...
public struct UkrainianUALayout: KeyboardLayout {
    public let id = "uk-UA"
    public let displayName = "Ukrainian (UA)"
    ...
    public init() {
        ...
        setLetter(&m, .bracketRight, "ї","Ї")

        // Home row
        setLetter(&m, .keyA, "ф","Ф")
        setLetter(&m, .keyS, "і","І")
